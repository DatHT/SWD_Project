...
--
/*!50003 DROP PROCEDURE IF EXISTS `GetFoodBaseOnUser` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetFoodBaseOnUser`(in user varchar(255), in member int,in ignorenumber int)
BEGIN
	select FoodName, Tutorial, LinkImage, MaterialInfo, Description from iCookDB.tbl_food where  User=user order by VisitNum DESC limit member offset ignorenumber; 
END ;;
DELIMITER ;
...
/*!50003 DROP PROCEDURE IF EXISTS `GetFoodHtml` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `GetFood_ID` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
BEGIN
    select FoodName, Tutorial, LinkImage, MaterialInfo, Description from iCookDB.tbl_food where  FoodID = Idsearch; 
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `SearchFood_FoodName` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
-- Dump completed on 2015-11-18 14:21:28
